            ...
            >
              ...
              <div className="p-4 md:p-6 flex flex-col flex-grow">
                ...
                <div className="border-t pt-4">
                  ...
                  <div className={`${
                    gift.reserved 
                      ? 'text-olive-600 font-medium flex items-center justify-center p-3 bg-olive-50 rounded-md'
                      : 'inline-block w-full text-center bg-olive-600 text-white px-6 py-2 rounded-md hover:bg-olive-700 transition-colors'
                  }`}>
                    {gift.reserved ? (
                      <>
